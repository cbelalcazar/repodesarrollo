...
class TCausalesDemoraController extends Controller
{
        ...
        */
        ...
        public $cdem_metrica = array('cdem_metrica', 'relation', 'select', 'Seleccionar metrica', 'Seleccionar la metrica deseada...','','met_nombre');
    ...
    public function index()
    {
        ...
        */
        $datos = DB::connection('importacionesV2')
                    ->table('t_causales_demora')
                    ->join('t_metrica', 't_causales_demora.cdem_metrica', '=', 't_metrica.id')
                    ->whereNull('t_causales_demora.deleted_at')
                    ->get();
