...
<div class="modal fade" id="ModalAnular" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <form name="anularForm" ng-submit="anularForm.$valid && anular()" novalidate>
          ...
          <h3>
          Negociación No. @{{infoSolicitud.sol_id}} / Estado:  @{{infoSolicitud.estado.ser_descripcion}} 
          </h3>
          <hr><br>
          <div class="row">
            <ul class="list-group">
          ...
          <div class="form-group">
            ...
            <textarea required maxlength="150" rows="2" style=" width: 800px;" ng-model="infoSolicitud.sol_observacionanulacion"></textarea>
          </div>
        </div>
