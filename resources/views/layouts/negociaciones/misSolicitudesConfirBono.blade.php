...
<div class="modal fade" id="ModalConfirBono" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog" style="width: 70% !important;" role="document">
        ...
        <textarea maxlength="150" rows="2" style=" width: 800px;" ng-model="infoSolicitud.sol_obsconfirbono"></textarea>
      </div>
		  <div class="modal-footer">
  		  <button class="btn btn-success" data-dismiss="modal" type="button">Confirmar</button>
