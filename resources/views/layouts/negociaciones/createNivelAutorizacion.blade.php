		...
		<form name="frmNivelesAuth" ng-submit="frmNivelesAuth.$valid && guardarPerNivel()" novalidate>		
		    <div class="modal-body">
	    		<div class="row">
					...
					<div  ng-if="(infoPerNivel.tipopersona.id != undefined &&  nivel[0].id > 1)" class="col-md-6 col-lg-6 col-xs-6 col-sm-6">
						<div class="form-group">
	    			...
	    			<div ng-if="(infoPerNivel.tipopersona.id === 2 &&  nivel[0].id === 1)" class="col-md-6 col-lg-6 col-xs-6 col-sm-6">
						<div class="form-group">
	    			...
	    			<div ng-if="(infoPerNivel.tipopersona.id === 1 &&  nivel[0].id === 1) || (infoPerNivel.tipopersona.id === 1 &&  nivel[0].id === 2 && infoPerNivel.persona.length == 1)  " class="col-md-6 col-lg-6 col-xs-6 col-sm-6">
						<div class="form-group">
							<label>Canal:</label> 
							<multiselect class="span-margin" ng-model="infoPerNivel.canales" options="canales" id-prop="can_id" display-prop="can_txt_descrip" show-select-all="true" placeholder="Seleccione Canales.." show-unselect-all="true" required></multiselect> 							
	    				</div>
	    			</div>
	    		...
	    		<div class="panel panel-primary" ng-if="(nivel[0].id === 1 || nivel[0].id === 2)&& infoPerNivel.canales.length > 0 && infoPerNivel.id == undefined && infoPerNivel.tipopersona.id == 1">
				    				...
				    				<td colspan="3">
				    					<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
											<div class="form-group">
												...
												<multiselect ng-if="nivel[0].id === 2" class="span-margin" ng-model="canal.terceros" options="canal.tercerosFiltrados" id-prop="idRowTercero" display-prop="cedulaNombre" placeholder="Seleccione Personas.." show-search="true" show-select-all="true" show-unselect-all="true" required></multiselect>
						    				</div>
						    			</div>	
				    				</td>
				    			</tr>
				...
				<div ng-if="nivel[0].id === 1 && infoPerNivel.tipopersona.id == 2 && infoPerNivel.territorio.length > 0">
					<md-content>
					    <md-tabs class="tabsConfigured" md-dynamic-height md-border-bottom>
					      <md-tab ng-repeat="territorio in infoPerNivel.territorio" label="@{{territorio.tnw_descripcion}} @{{calcularCantidadPersonas(territorio.canales)}}">
					        <md-content class="md-padding content-tab-padre">
					        	<div class="form-group">
									<label>Canal:</label> 
									<multiselect class="span-margin" ng-model="territorio.canales" options="canales" id-prop="can_id" display-prop="can_txt_descrip" ng-change="filtrarAutorizaA()" show-select-all="true" placeholder="Seleccione Canales.." show-unselect-all="true" required></multiselect>
		    					</div>
		    					<md-content>
								    <md-tabs ng-if="infoPerNivel.id == undefined" class="tabsConfigured-slim" md-dynamic-height md-border-bottom>
								      <md-tab ng-repeat="canTer in territorio.canales" label="@{{canTer.can_txt_descrip}} (@{{canTer.personas.length == undefined ? 0 : canTer.personas.length}})">
								        <md-content ng-if="infoPerNivel.id == undefined" class="md-padding content-tab-hijos">
								        	<div class="form-group">
												<label>Persona(s):</label> 
												<multiselect class="span-margin" ng-model="canTer.personas" options="terceros" id-prop="idRowTercero" display-prop="cedulaNombre" placeholder="Seleccione Personas.." show-search="true" show-select-all="true" show-unselect-all="true" required></multiselect>
						    				</div>
				...
				<div class="panel panel-primary" ng-if="nivel[0].id != 1 && infoPerNivel.tipopersona.id === 3">
				    	...
				    	<div ng-repeat="can in infoPerNivel.canales" class="panel panel-default">
						    ...
						    <div class="panel-body">
						    	<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
									<div class="form-group">
										<label>Lineas:</label> 
										<multiselect ng-init="" class="span-margin" ng-model="can.lineas" options="filtrarLineasCanal(can)" id-prop="lin_id" display-prop="lin_txt_descrip" placeholder="Seleccione Personas.." show-search="true" show-select-all="true" show-unselect-all="true" required></multiselect> 	
