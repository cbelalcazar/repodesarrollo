...
@section('content')
    @if ($objTSolEnvioNego['sen_ser_id'] == 2)
      @if($objTSolEnvioNego['validacionAuditoria'] == 'false')
        ...
        @endif
      @else
        <p>El usuario <strong>{{$objTSolEnvioNego['terceroEnvia']['nombreTercero']}} {{$objTSolEnvioNego['terceroEnvia']['apellido1Tercero']}} {{$objTSolEnvioNego['terceroEnvia']['apellido2Tercero']}}</strong> ha realizado la <strong>NEGOCIACIÓN NO. {{$objTSolEnvioNego['sen_sol_id']}}</strong> con la fecha del evento anterior a la fecha actual.</p>
        <div class="form-group">
          <label><strong>Estado: </strong></label> En Solicitud
        </div> 
      @endif
    @elseif ($objTSolEnvioNego['sen_ser_id'] == 8)
      <!-- Correcciones -->
      <p>El usuario <strong>{{$objTSolEnvioNego['terceroEnvia']['nombreTercero']}} {{$objTSolEnvioNego['terceroEnvia']['apellido1Tercero']}} {{$objTSolEnvioNego['terceroEnvia']['apellido2Tercero']}}</strong> ha enviado a correcciones la <strong>NEGOCIACIÓN No. {{$objTSolEnvioNego['sen_sol_id']}}</strong> la cual corresponde al cliente <strong>
      {{$objTSolEnvioNego['solicitud']['cliente']['razonSocialTercero_cli']}}</strong>.</p>
      
      <div class="form-group">
          <label><strong>Estado: </strong></label>Correcciones
        </div>
      <div class="form-group">
        <label><strong>Observaciones: </strong></label> {{$objTSolEnvioNego['sen_observacion']}}
      </div>
      <p>Debe ingresar al sistema y realizar las correcciones de la negociación en menos de 24 horas.</p>
      <p>Para ir al Aplicativo haga clic <a href="http://www.bellezaexpress.com/aplicativos">aqui</a>.</p>
