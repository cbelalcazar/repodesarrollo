...
<!-- @elseif ($objTSolEnvioNego['sen_ser_id'] == 3)

  <p>El usuario <strong>Fulanito</strong> ha aprobado la <strong>NEGOCIACIÓN No. XXXXX</strong> la cual
    corresponde al cliente <strong>NNNNNN</strong>.</p>
  <div class="form-group">
    <label><strong>Estado: </strong></label> Aprobación Director
  </div>
  <div class="form-group">
    <label><strong>Observaciones: </strong></label> Aprobación Director
  </div>
  <div class="form-group">
    <label><strong>Forma de Pago: </strong></label> Aprobación Director
  </div>
  <p>Debe ingresar al sistema y realizar la aprobación de la negociación en menos de 24 horas.</p>
  <p>Para ir al Aplicativo haga clic <a href="http://www.bellezaexpress.com/aplicativos">aqui</a>.</p>

@elseif ($objTSolEnvioNego['sen_ser_id'] == 4 || $objTSolEnvioNego['sen_ser_id'] == 5)

  <p>El usuario <strong>Fulanito</strong> ha filtrado la <strong>NEGOCIACIÓN No. XXXXX</strong> la cual
    corresponde al cliente <strong>NNNNNN</strong>.</p>
  <div class="form-group">
    <label><strong>Estado: </strong></label> Filtro
  </div>
  <div class="form-group">
    <label><strong>Observaciones: </strong></label> Filtro
  </div>
  <div class="form-group">
    <label><strong>Forma de Pago: </strong></label> Filtro
  </div>
  <p>Debe ingresar al sistema y realizar el filtro de la negociación en menos de 24 horas.</p>
  <p>Para ir al Aplicativo haga clic <a href="http://www.bellezaexpress.com/aplicativos">aqui</a>.</p>

@elseif ($objTSolEnvioNego['sen_ser_id'] == 6 || $objTSolEnvioNego['sen_ser_id'] == 7)

  <p>El usuario <strong>Fulanito</strong> ha aprobado la <strong>NEGOCIACIÓN No. XXXXX</strong> la cual
    corresponde al cliente <strong>NNNNNN</strong>.</p>
  <div class="form-group">
    <label><strong>Estado: </strong></label> Aprobación Gerencia
  </div>
  <div class="form-group">
    <label><strong>Observaciones: </strong></label> Filtro
  </div>
