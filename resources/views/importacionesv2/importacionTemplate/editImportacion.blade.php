...
<div id="menu-5">
  ...
  <div class="form-group">
    ...
    {{ Form::text("imp_fecha_entrega_total", \Carbon\Carbon::parse($objeto->imp_fecha_entrega_total)->format('d-m-Y'), ['class' => 'form-control', 'id' =>  'imp_fecha_entrega_total', 'placeholder' =>  'Ingresar fecha de entrega total de la mercancia', 'readonly' =>  'readonly']) }}
    @else
