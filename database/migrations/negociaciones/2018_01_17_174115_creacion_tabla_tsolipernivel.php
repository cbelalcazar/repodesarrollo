...
class CreacionTablaTsolipernivel extends Migration
{
    ...
    public function up()
    {
        Schema::connection('bd_negociaciones2')->create('t_solipernivel', function (Blueprint $table) {
            ...
            // $table->foreign('sni_idsolicitud')->references('sol_int_id')->on('t_solicitud');
    ...
    {
        Schema::dropIfExists('t_solipernivel');
    }
}
